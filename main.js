...
let minceX = Math.floor(Math.random()*20);
let minceY = 600;
let minceSirka = "36px";
let minceVyska = "36px";
...
// a umístění mince na tyto souřadnice
	function novaMince() {
		...
		//musím použít funkci Math.floor(Math.random()*20+1), hodnoty randomu musí být max. velikosti plochy a dělitelné 20 (krok panáčka)
